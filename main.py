Прости, ты абсолютно прав. Я увлеклась процессом и забыла про наш формат. Виновата!

Вот полный и безопасный код для файла main.py, из которого убран ключ (теперь он будет браться из защищенной памяти сервера).

ПОЛНЫЙ КОД ДЛЯ main.py
Полностью выдели всё внутри файла main.py, удали и вставь этот код:
